  ...
  return (
    <div className="container">
      <header className="mb-4">
        <h1>Here Create Your New Blog or Event</h1>
        <nav>
          <Link to="/">Health Blog</Link>
          <Link to="/cus">Participation Details </Link>
      ...
      <div className="row mb-5">
        <div className="col-md-6">
          <form className="p-3 border rounded" onSubmit={sendData}>
            <h3>Add Health Blogs</h3>
        ...
        <div className="col-md-6">
          <form className="p-3 border rounded" onSubmit={sendDataevent}>
            <h3>Add Health Events</h3>
            ...
            <div className="form-group">
              <label htmlFor="eventauthorname">Author Name</label>
              <input
                type="text"
                className="form-control"
                id="eventauthorname"
