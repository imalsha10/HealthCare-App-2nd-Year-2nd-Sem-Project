    ...
    <div className="container">
      <section className="container-view">
        ...
        <div className="content">
          <h2 style={{ color: "#001f3f" }}>Find & Book Appointment With Your Favourite Doctors</h2>
      ...
      <div>
        ...
        <h4>
                    "Empowering Wellness: Unveiling Our Care's Palette of Services"</h4>
      ...
      <div className="body-container clearfix">
        ...
        <div className="doctors-list">
          {filteredDoctors.map((doctor) => (
            <div className="doctor-card" style={{ color: "black" }} key={doctor._id}>
              <div className="image">
                <img
                  src={doctor.img}
                  alt="doctor"
